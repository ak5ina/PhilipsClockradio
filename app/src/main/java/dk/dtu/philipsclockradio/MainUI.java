...
public class MainUI extends AppCompatActivity implements OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fmamTextView = (TextView) findViewById(R.id.fmamText);
    ...
    public void toggleRadioPlaying(boolean onOff){
    ...
    //MINE METODER
    public void toggleFMAMplaying(Boolean playingFM) {
        if (playingFM) {
            fmamTextView.setText("FM");
        } else {
            fmamTextView.setText("AM");
        }
    }

    public void updateFMAMtext(boolean FMSon, String frekvens){

        if (FMSon) {
            fmtextview.setText("FM frekvens: " + frekvens);
        } else {
